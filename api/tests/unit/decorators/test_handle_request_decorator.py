...
def test_handle_request_decorator_get_request(
    mock_handle_get_request, fake_data_schema, flask_app
):
    ...
    with flask_app.test_request_context():
        with patch("app.decorators.views.request") as mock_request_context:
            # Setup mocks
...
def test_handle_request_decorator_post_request(
    mock_handle_post_or_put_request, fake_data_schema, flask_app
):
